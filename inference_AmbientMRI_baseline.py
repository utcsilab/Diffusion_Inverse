...
results_dir = '/csiNAS2/slow/brett/ambientmri_baseline_DPS_results/sample%d/R=%d/'%(args.sample,args.R)
...
net_save = '/csiNAS2/slow/brett/edm_outputs/00055-clean_data-uncond-ddpmpp-edm-gpus4-batch28-fp32-ambient_baseline_test/network-snapshot-004032.pkl'
if dist.get_rank() != 0:
